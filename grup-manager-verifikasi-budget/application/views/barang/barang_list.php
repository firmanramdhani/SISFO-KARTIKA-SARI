    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('barang/read/'.$barang->idbarang),'Read'); 
				echo ' | '; 
				echo anchor(site_url('barang/update/'.$barang->idbarang),'Update'); 
				echo ' | '; 
				echo anchor(site_url('barang/delete/'.$barang->idbarang),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<button onclick="location.href='/ci/login/logout'">
			Logout
		</button>
		<p>
