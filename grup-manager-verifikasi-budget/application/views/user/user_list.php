    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('user/read/'.$user->userid),'Read'); 
				echo ' | '; 
				echo anchor(site_url('user/update/'.$user->userid),'Update'); 
				echo ' | '; 
				echo anchor(site_url('user/delete/'.$user->userid),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
