    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('pegawai/read/'.$pegawai->idpegawai),'Read'); 
				echo ' | '; 
				echo anchor(site_url('pegawai/update/'.$pegawai->idpegawai),'Update'); 
				echo ' | '; 
				echo anchor(site_url('pegawai/delete/'.$pegawai->idpegawai),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
