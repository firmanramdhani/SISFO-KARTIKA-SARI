                    ...
                    <div class="shp__cart__wrap">
                        <div class="shp__single__product">
                            <div class="shp__pro__thumb">
                                <a href="#">
                                    <img src="<?php echo base_url() ?>assets/images/product-2/sm-smg/1.jpg" alt="product images">
                                </a>
                            </div>
                        ...
                        <form action="#">
                            <div class="table-content table-responsive">
                                <table>
                                    ...
                                    <tbody>
                                      <?php $total=0; foreach ($data as $d): ?>
                                        <tr>
                                            <td class="product-thumbnail"><img src="<?php echo $d->url ?>" alt="product img" /></a></td>
                                        ...
                                        <?php $total += $subtotal; $idtrans = $this->session->userdata('idtrans');?>
                                      <?php endforeach; ?>
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 smt-40 xmt-40">
                                    <div class="htc__cart__total">
                                        ...
                                        <ul class="payment__btn">
                                            <li class="active"><a href="<?php echo base_url('order/cekout/'.$idtrans.'/'.$total) ?>">Order</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
